...
use App\Filament\Admin\Resources\ReportsResource\Pages;
use App\Models\Book;
                    ...
                    ->url(
                        fn($record) => match ($record["slug"]) {
                            "book-circulation" => route(
                                "filament.admin.resources.reports.book-reports",
                            ),
                            "financial-summary" => route(
                                "filament.admin.resources.reports.financial-reports",
                            ),
                            "member-statistics" => route(
                                "filament.admin.resources.reports.member-reports",
                            ),
                            "inventory-status" => route(
                                "filament.admin.resources.reports.inventory-reports",
                            ),
                            "transaction-details" => route(
                                "filament.admin.resources.reports.transaction-reports",
                            ),
                            default => "#",
                        },
                    )
